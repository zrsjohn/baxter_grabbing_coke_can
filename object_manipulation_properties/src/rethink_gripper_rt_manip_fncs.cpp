...
void rethink_grasp_COKE_CAN_ID(int query_code, int grasp_option,
    ...
    // object_grasp_poses_wrt_gripper.push_back(object_pose_wrt_gripper);
    /*
    object_pose_wrt_gripper.orientation.x = Q.x(); //x-axis anti-parallel, z-axis anti-parallel:
    object_pose_wrt_gripper.orientation.y = Q.y();//grasp from side
    object_pose_wrt_gripper.orientation.z = Q.z();
    object_pose_wrt_gripper.orientation.w = Q.w();
    */
