...
int main(int argc, char** argv) {
    ...
    object_grabber_goal.object_code = object_grabber::object_grabberGoal::GRAB_CORK_CAN; //specify the object to be grabbed
    ...
    //stuff a goal message:
    object_grabber_goal.object_code = object_grabber::object_grabberGoal::PLACE_COKE_CAN; 
